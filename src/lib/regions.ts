...
export const regions: Region[] = [
  {
    ...
    lng: 7.0098,
    intro:
      "Als Webdesigner aus dem Saarland erstelle ich für Unternehmen in Saarbrücken professionelle, suchmaschinenoptimierte Websites, die nachweislich Kunden bringen. Persönliche Betreuung, faire Festpreise ab 990€ und ein kostenloser Entwurf in 24 Stunden.",
    paragraphs: [
      ...
      "Über 75 % der Nutzer beurteilen die Glaubwürdigkeit eines Unternehmens anhand seiner Website. Eine veraltete, langsame oder nicht mobiloptimierte Seite kostet Sie messbar Umsatz. Genau hier setze ich an: mit modernen, schnellen Websites, die für Saarbrücken, Dudweiler, Burbach, Malstatt und das gesamte Saarland optimiert sind.",
  ...
  },
  {
    ...
    paragraphs: [
      "Saarlouis ist Kreisstadt und einer der wichtigsten Wirtschaftsstandorte im Westen des Saarlandes. Während die meisten Webdesign-Agenturen in Saarbrücken sitzen, profitieren Sie bei mir von einem Ansprechpartner, der die Region Saarlouis, Dillingen, Lebach und Wallerfangen wirklich kennt – mit kurzen Wegen und persönlicher Betreuung.",
      "Lokale Unternehmen in Saarlouis – ob Handwerk, Gastronomie, Einzelhandel oder Dienstleistung – stehen vor der gleichen Herausforderung: Kunden suchen heute zuerst online. Wer bei Google Maps und in den lokalen Suchergebnissen nicht oben steht, wird übersehen. Ich baue Websites, die genau dafür gemacht sind: für lokale Sichtbarkeit in Saarlouis und messbar mehr Anfragen.",
      "Vom Design über die technische Umsetzung bis zur Suchmaschinenoptimierung erhalten Sie alles aus einer Hand. Auf Wunsch ergänze ich Ihre Website mit gezielten Google Ads für Saarlouis und Umgebung – für sofort sichtbare Ergebnisse.",
    ],
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Ich erstelle für Sie eine Website, die in Völklingen, Wadgassen und Püttlingen bei Google gefunden wird – mit sauberer Technik, schnellen Ladezeiten, mobiler Optimierung und lokaler Suchmaschinenoptimierung. Keine Agentur-Hotline, keine Warteschleife: Sie haben einen festen Ansprechpartner.",
      "Auf Wunsch betreue ich Ihre Google Ads-Kampagnen für Völklingen und richte Google Business Profile professionell ein – damit Sie auch in Google Maps und der lokalen Suche oben erscheinen.",
    ],
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Ich entwickle Websites speziell für Unternehmen in Merzig, Mettlach, Perl und Wadern: schnell, mobiloptimiert, von Anfang an für lokale Suchanfragen ausgerichtet. So werden Sie von Kunden gefunden, die genau Ihre Leistung in Ihrer Region suchen.",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Ich baue Ihre Website von Grund auf für Neunkirchen, Spiesen-Elversberg, Schiffweiler und Illingen: lokal optimiert, technisch sauber, schnell und mobil-tauglich. Lokale SEO und Google Business Optimierung sind fester Bestandteil – nicht teures Zusatzpaket.",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Ich entwickle Websites, die für Homburg, Kirkel, Bexbach und Blieskastel optimiert sind: schnell, modern, lokal SEO-optimiert und auf Conversion ausgerichtet. So werden Anfragen über Ihre Website spürbar mehr.",
      "Auf Wunsch betreue ich auch Ihre Google Ads-Kampagnen und Google Business Profile für maximale lokale Sichtbarkeit – alles aus einer Hand, persönlich und transparent.",
    ],
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Ich erstelle für Sie eine Website, die für St. Ingbert, Rohrbach, Hassel und Oberwürzbach optimiert ist: technisch sauber, mobiloptimiert und mit lokaler SEO direkt eingebaut. Keine Vorlagen, sondern individuelles Design für Ihr Unternehmen.",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Ich entwickle Websites, die speziell für Dillingen, Saarlouis, Rehlingen-Siersburg und Beckingen optimiert sind. Sauberer Code, mobile-first Design und lokale SEO sorgen dafür, dass Sie bei Google ganz oben mitspielen.",

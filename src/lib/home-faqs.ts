...
export const homeFaqs: FAQ[] = [
  ...
  },
  {
    ...
    a: 'Kleine Auftritte in zwei bis vier Wochen. Größere Vorhaben mit SEO-Aufbau, Google Ads und mehreren Unterseiten in vier bis sechs Wochen. Danach begleiten wir die ersten Monate nach Live-Gang.',
  },
  {
    q: 'Was unterscheidet Fylu Marketing von anderen Anbietern?',
    a: 'Sie sprechen direkt mit dem Ansprechpartner. Keine Account-Manager-Kette, keine Templates von der Stange. Wir arbeiten mit einer überschaubaren Zahl an Kunden, damit jedes Projekt die nötige Aufmerksamkeit bekommt.',
  },
  {
  ...
  },
  {
    ...
    a: 'Etwa 15 bis 30 Minuten, telefonisch oder per Video. Wir hören zu, geben eine ehrliche Einschätzung. Passt es, folgt zeitnah ein konkretes Angebot.',
  },
];

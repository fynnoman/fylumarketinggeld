  ...
  return (
    <>
      ...
      <div className="hidden md:block fixed top-6 right-6 z-50">
        <Link href="/angebote">
          <button className="bg-gradient-to-r from-cyan-500 to-cyan-600 hover:from-cyan-600 hover:to-cyan-700 text-white px-6 py-3 rounded-xl font-bold shadow-2xl transition-all duration-200 hover:shadow-[0_12px_40px_rgba(6,182,212,0.4)] active:scale-[0.98]">
            Projekt starten
          </button>
        </Link>
      </div>

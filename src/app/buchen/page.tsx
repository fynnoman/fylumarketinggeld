...
const packages = [
	{
		...
		price: 990,
		description:
			'Perfekt für kleine lokale Betriebe, die endlich online gefunden werden wollen. Mit Hingabe fertige ich Ihre neue Website an – professionell, schnell und ohne Schnickschnack.',
		features: [
	...
	},
	{
		...
		price: 1490,
		description:
			'Ihre Website wird zur echten Kundenquelle. Verkaufspsychologisch durchdacht, strategisch aufgebaut – damit Besucher zu zahlenden Kunden werden.',
		features: [
	...
	},
	{
		...
		price: 2490,
		description:
			'Für Unternehmen, die nicht mitspielen, sondern dominieren wollen. Strategische Positionierung, Premium-Design und technische Perfektion.',
		features: [
	...
	},
	{
		...
		price: 0,
		description:
			'Komplett individuelle Lösung nach Ihren Wünschen. Lassen Sie uns gemeinsam Ihr perfektes Projekt gestalten.',
		features: [
...
function BuchenPageInner() {
	...
	const canProceedStep3 =
		...
		formData.datenschutzAccepted &&
		formData.widerrufsrechtAccepted;
					...
					<form className="space-y-8">
						...
						<div className="bg-stone-50 rounded-2xl p-8">
							<h2 className="text-2xl font-bold text-stone-900 mb-4">
								Ihre Wünsche & Präferenzen
							</h2>
							<p className="text-stone-600 mb-6">
								Teilen Sie mir Ihre Design-Wünsche, Farbpräferenzen, Vorbilder oder
								andere wichtige Informationen mit.
							</p>
					...
					<div className="space-y-8">
							...
							<div className="space-y-4">
									...
									<div>
										...
										<p className="text-stone-700">
											...
											<strong className="text-cyan-600">
												{anzahlung.toLocaleString('de-DE', {
													minimumFractionDigits: 2,
												})}€
											</strong>{' '}
											(50% + MwSt.).
								...
								<div className="flex gap-4">
									...
									<div>
										...
										<p className="text-stone-700">
											Ich erstelle Ihre Website nach Ihren Wünschen und
											Präferenzen.
										</p>
									</div>
								</div>
								...
								<div className="flex gap-4">
									...
									<div>
										...
										<p className="text-stone-700">
											Ich stelle Ihnen das Ergebnis vor. Sie haben{' '}
											<strong>5 Tage Zeit</strong> für Änderungswünsche.
										</p>
									</div>
								</div>
								...
								<div className="flex gap-4">
									...
									<div>
										<h3 className="font-bold text-stone-900 mb-1">
											Restzahlung & Veröffentlichung
										</h3>
										<p className="text-stone-700">
											Nach Freigabe zahlen Sie{' '}
											<strong className="text-cyan-600">
												{restbetrag.toLocaleString('de-DE', {
													minimumFractionDigits: 2,
												})}€
											</strong>{' '}
											und Ihre Website geht live!
										</p>
									</div>
								</div>
							</div>
						...
						<div className="bg-stone-50 rounded-2xl p-8 space-y-4">
							...
							<label className="flex items-start gap-3 cursor-pointer group">
								...
								/>
								<span className="text-stone-700 group-hover:text-stone-900 transition-colors">
									Ich verzichte auf mein{' '}
									<strong>Widerrufsrecht nach Beginn der Arbeiten</strong> und
									stimme zu, dass die Dienstleistung sofort nach
					...
					<div className="bg-stone-50 rounded-2xl p-8 mb-8">
						...
						<div className="bg-white rounded-lg p-6 mb-6 max-h-96 overflow-y-auto border-2 border-stone-200">
							<h3 className="font-bold text-lg mb-4">
								Vertrag zwischen Fylu und{' '}
								{formData.firmName || '[Kunde]'}
							</h3>
							...
							<div className="space-y-4 text-stone-700 text-sm">
								...
								<p>
									Der Auftragnehmer (Fylu) verpflichtet sich zur Erstellung
									einer Website gemäß Paket "{selectedPackage.name}" mit
								...
								<p>
									...
									(brutto) und setzt sich wie folgt zusammen:
								</p>
								<ul className="list-disc list-inside pl-4 space-y-1">
								...
								<p>
									<strong>§3 Zahlungsmodalitäten</strong>
								</p>
								...
								<p>
									<strong>§4 Projektablauf</strong>
								</p>
								<ul className="list-disc list-inside pl-4 space-y-1">
									<li>
										Nach Eingang der Anzahlung beginnt die Umsetzung
									</li>
									<li>
										Der Auftraggeber erhält eine Präsentation des fertigen
										Projekts
									</li>
									<li>
										Der Auftraggeber hat 5 Werktage Zeit für
										Änderungswünsche
									</li>
									<li>
										Nach Freigabe erfolgt die Restzahlung und
										Veröffentlichung
									</li>
								</ul>
								...
								<p>
									Der Auftraggeber verzichtet ausdrücklich auf sein
									Widerrufsrecht, sobald mit der Ausführung der Dienstleistung
									begonnen wurde.
								</p>
								...
								<p>
									Der Auftragnehmer garantiert eine professionelle Ausführung
									nach aktuellem Standard. Technische Fehler werden kostenlos
									behoben.
								</p>
						...
						<div className="space-y-4">
							<div>
								...
								<p className="text-xs text-stone-500 mt-2">
									Durch Eingabe Ihres Namens bestätigen Sie die Richtigkeit der
									Angaben und akzeptieren den Vertrag.
								</p>
							</div>
			...
			<div className="min-h-screen bg-white">
				<header className="bg-gradient-to-r from-cyan-500 to-cyan-600 text-white py-12 px-6">
					<div className="max-w-4xl mx-auto">
						...
						<p className="text-cyan-100 mt-2">
							Schritt 5 von 5 – Wählen Sie Ihr Service-Modell
						</p>
					</div>
				</header>
				...
				<div className="max-w-4xl mx-auto px-6 py-12">
					...
					<div className="mb-8">
						<h2 className="text-2xl font-bold text-stone-900 mb-4">
							Welchen Service möchten Sie nach der Erstellung?
						</h2>
						<p className="text-stone-600 mb-6">
							Wählen Sie, wie Sie nach der Website-Erstellung weitermachen
							möchten:
						</p>
						...
						<div className="grid md:grid-cols-2 gap-6 mb-8">
							...
							<motion.div
								whileHover={{ scale: 1.02 }}
								onClick={() =>
									setFormData({ ...formData, serviceOption: 'premium' })
								}
							...
							>
								...
								<div className="space-y-3 mb-6">
									...
									<div className="flex items-start gap-2">
										...
										<span className="text-stone-700">
											Neue Ideen & saisonale Specials (z.B.
											Oster-/Weihnachts-Aktionen)
										</span>
									</div>
									<div className="flex items-start gap-2">
										<svg
										...
										<span className="text-stone-700">
											Domain-Kosten (wird abgerechnet)
										</span>
									</div>
									<div className="flex items-start gap-2">
										<svg
								...
								<div className="bg-white rounded-lg p-4 border-2 border-cyan-200">
									<p className="text-xs text-stone-600">
										<strong>Ideal für:</strong> Unternehmen, die langfristig
										wachsen und ihre Website kontinuierlich optimieren
										möchten.
									</p>
								</div>
							</motion.div>
							...
							<motion.div
								whileHover={{ scale: 1.02 }}
								onClick={() =>
									setFormData({ ...formData, serviceOption: 'basic' })
								}
							...
							>
								...
								<div className="mb-4">
									...
									<p className="text-3xl font-bold text-stone-700 mb-1">
										0€ / Jahr
									</p>
									<p className="text-sm text-stone-500">
								...
								<div className="bg-white rounded-lg p-4 border-2 border-stone-200">
									<p className="text-xs text-stone-600">
										<strong>Ideal für:</strong> Unternehmen, die ihre Website
										selbst verwalten möchten und nur bei Bedarf Unterstützung
										brauchen.
									</p>
								</div>
							</motion.div>
						...
						<div className="space-y-3">
							...
							{formData.serviceOption && (
								<div className="flex justify-between">
									...
									<span className="font-semibold text-stone-900">
										{formData.serviceOption === 'premium'
											? 'Premium Service (132€/Jahr)'
											: 'Basis Service (0€/Jahr)'}
									</span>
								</div>
							)}
							{formData.preferences && (
								<div className="border-t border-cyan-300 pt-3 mt-3">
									...
									<p className="text-stone-600 text-sm italic">
										{formData.preferences.substring(0, 150)}
										{formData.preferences.length > 150 ? '...' : ''}
									</p>
								</div>
							)}
						...
						<div className="flex gap-4">
							...
							<div>
								<h3 className="text-xl font-bold text-stone-900 mb-3">
									📸 Wichtig: Materialien bereitstellen
								</h3>
								<p className="text-stone-700 mb-4">
									Nach Ihrer Buchung benötige ich von Ihnen Logos, Bilder,
									Texte und andere Materialien für Ihre Website.
								</p>
								<div className="bg-white rounded-lg p-4 border-2 border-amber-200">
									<p className="text-stone-800 mb-3 font-semibold">
										Bitte senden Sie mir diese innerhalb von{' '}
										<span className="text-amber-600">10 Werktagen</span> zu:
									</p>
									<div className="space-y-2">
										...
										<div className="flex items-center gap-2">
											...
											<span className="text-stone-700">
												...
												<a
													href="https://wa.me/4915168488999"
													target="_blank"
									...
									<p className="text-xs text-stone-500 mt-3">
										Logos, Bilder (hochauflösend), Texte, Farbwünsche, und
										alle anderen relevanten Materialien
									</p>
								</div>
							</div>
						</div>
					...
					<motion.button
						...
						whileHover={{
							scale: canProceedStep5 && !isCheckingOut ? 1.02 : 1,
						}}
						whileTap={{
							scale: canProceedStep5 && !isCheckingOut ? 0.98 : 1,
						}}
					...
					<p className="text-center text-sm text-stone-500 mt-4">
						Nach Klick werden Sie zur sicheren Zahlungsabwicklung von Stripe
						weitergeleitet
					</p>
				</div>
			</div>

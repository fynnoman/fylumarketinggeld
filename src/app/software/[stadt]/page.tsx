...
export async function generateMetadata({
  ...
  const title = isTop
    ? `Software ${region.city} · Web-Apps & ERP · Festpreis ab 4.900€`
    : `Software ${region.city} | Fylu Programmierer Saarland`;
  const description = isTop
    ? `Softwareentwicklung für ${region.city}: individuelle Web-Apps, ERP, CRM und API-Integrationen. Festpreis, Stack-transparent, persönliche Betreuung aus Saarlouis.`

...
export default function WebdesignerSaarlouisPage() {
    ...
    <main>
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { "@type": "ListItem", position: 2, name: "Webdesigner Saarlouis", item: "https://www.fylumarketing.de/webdesigner-saarlouis" },
            ],
          }),
        }}
      />
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "LocalBusiness",
            name: "Fylu – Webdesigner Saarlouis",
            description: "Webdesigner für Saarlouis. Individuelle Websites, SEO und Google Ads für lokale Unternehmen. Konkurrenz sitzt in Saarbrücken!",
            url: "https://www.fylumarketing.de/webdesigner-saarlouis",
            ...
            geo: { "@type": "GeoCoordinates", latitude: 49.3139, longitude: 6.7516 },
            priceRange: "€€",
            areaServed: [ { "@type": "City", name: "Saarlouis" }, { "@type": "State", name: "Saarland" }, { "@type": "Country", name: "Deutschland" } ],
          }),
        }}
      />
      <section className="relative py-20 md:py-32 px-6 bg-white overflow-hidden">
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          >
            Webdesigner Saarlouis – Ihre Website, Ihr Vorteil
          </motion.h1>
          <motion.p

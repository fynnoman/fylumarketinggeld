...
export default function WebdesignerMerzigPage() {
    ...
    <main>
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { "@type": "ListItem", position: 2, name: "Webdesigner Merzig", item: "https://www.fylumarketing.de/webdesigner-merzig" },
            ],
          }),
        }}
      />
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "LocalBusiness",
            name: "Fylu – Webdesigner Merzig",
            description: "Webdesigner für Merzig. Individuelle Websites, SEO und Google Ads für lokale Unternehmen.",
            url: "https://www.fylumarketing.de/webdesigner-merzig",
            telephone: "+4915168488999",
            email: "kontakt@fylumarketing.de",
            address: { "@type": "PostalAddress", addressLocality: "Merzig", addressRegion: "Saarland", addressCountry: "DE" },
            geo: { "@type": "GeoCoordinates", latitude: 49.4431, longitude: 6.6371 },
            priceRange: "€€",
            areaServed: [ { "@type": "City", name: "Merzig" }, { "@type": "State", name: "Saarland" }, { "@type": "Country", name: "Deutschland" } ],
          }),
        }}
      />
      <section className="relative py-20 md:py-32 px-6 bg-white overflow-hidden">
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          >
            Webdesigner Merzig – Ihre Website, Ihr Vorteil
          </motion.h1>
          <motion.p

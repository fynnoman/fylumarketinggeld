...
const faqs = [
	{
		...
		a: 'Jedes Projekt wird individuell auf Umfang und Zielsetzung zugeschnitten. Der endgültige Rahmen entsteht im Vorgespräch, transparent und ohne versteckte Kosten. Auch ein schlanker Refresh einer bestehenden Website ist möglich.',
	},
	{
		q: 'Ich habe keine Zeit, mich zu kümmern. Wie läuft das ab?',
		a: 'Fünfzehn Minuten Vorgespräch. Sie erzählen uns kurz, was Sie machen und was Sie sich wünschen. Den Rest übernimmt Fylu Marketing. Kein Papierkram, keine Ticket-Systeme, direkter Draht.',
	},
	{
	...
	},
	{
		...
		a: 'Kein Problem. Kleine Änderungen wie Texte oder Bilder sind schnell erledigt. Auf Wunsch können Sie ein Content-Management-System bekommen, mit dem Sie selbst Inhalte aktualisieren können. Oder wir übernehmen Änderungen für Sie, schnell und zu fairen Konditionen.',
	},
];
				...
				<div className="max-w-4xl mx-auto relative z-10">
					...
					<FadeInSection delay={0.16}>
						<p className="mt-8 text-lg md:text-[1.1rem] text-stone-600 leading-relaxed max-w-3xl">
							Fylu Marketing baut moderne Websites für Meisterbetriebe:
							mobile-first, technisch sauber, bei Google sichtbar. Für Maler,
							Elektriker, SHK-Betriebe, Dachdecker, Schreiner, Fliesenleger,
							Gartenbauer und alle Gewerke, die online neue Aufträge gewinnen
							wollen.
						</p>
					</FadeInSection>
				...
				<div className="max-w-4xl mx-auto">
					...
					<div className="space-y-8">
						{[
							...
							{ title: 'Website geht live', text: 'Ihre fertige Website geht online. Wir kümmern uns um Domain, Hosting und alles Technische. Sie freuen sich über neue Anfragen.' },
						].map((step, i) => (
			...
			<section className="py-20 md:py-28 px-6 bg-white">
				<div className="max-w-3xl mx-auto text-center">
					...
					<div className="mt-10 flex flex-wrap justify-center gap-x-5 gap-y-2 text-[11px] uppercase tracking-[0.22em] text-stone-500">
						...
						<Link href="/seo-saarland" className="hover:text-cyan-700 transition-colors">SEO Saarland</Link>
						<span className="text-stone-300">·</span>

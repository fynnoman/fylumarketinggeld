...
export default function WebdesignerHomburgPage() {
    ...
    <main>
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { "@type": "ListItem", position: 2, name: "Webdesigner Homburg", item: "https://www.fylumarketing.de/webdesigner-homburg" },
            ],
          }),
        }}
      />
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "LocalBusiness",
            name: "Fylu – Webdesigner Homburg",
            description: "Webdesigner für Homburg. Individuelle Websites, SEO und Google Ads für lokale Unternehmen.",
            url: "https://www.fylumarketing.de/webdesigner-homburg",
      ...
      <section className="relative py-20 md:py-32 px-6 bg-white overflow-hidden">
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          >
            Webdesigner Homburg – Ihre Website, Ihr Vorteil
          </motion.h1>
          <motion.p

    ...
    <main>
      ...
      <section className="relative py-20 md:py-32 px-6 bg-white overflow-hidden">
        ...
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          >
            Ihr Unternehmen im Saarland verdient eine Website, die nicht nur gut aussieht, sondern auch Ergebnisse liefert. Als Webdesigner aus Saarlouis erstelle ich professionelle, suchmaschinenoptimierte Websites für Unternehmen in Saarbrücken, Merzig, Dillingen, Neunkirchen, St. Wendel und dem gesamten Saarland. Mein Ziel: Ihre Website wird zum wichtigsten Vertriebskanal Ihres Unternehmens. Ob Handwerksbetrieb, Dienstleister, Einzelhändler oder Gastronom — ich verstehe die Bedürfnisse lokaler Unternehmen und baue Websites, die bei Google gefunden werden und Besucher in Kunden verwandeln. Kein Template-Einheitsbrei, sondern individuelle Lösungen mit persönlicher Betreuung. Ab 990€, mit kostenlosem Entwurf in 24 Stunden.
          </motion.p>
          <motion.div
            initial={{ opacity: 0, y: 16 }}
            animate={{ opacity: 1, y: 0 }}
      ...
      <section className="py-20 md:py-28 px-6 bg-stone-50">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="prose prose-lg prose-stone max-w-none">
            ...
            <p>
              SEO ist bei mir kein Zusatzpaket, sondern fester Bestandteil jeder Website. Von der Keyword-Recherche über technisches SEO bis zur Google Business Optimierung — Ihre Website wird von Anfang an so gebaut, dass Google sie liebt. Und das Beste: Sie haben einen persönlichen Ansprechpartner. Kein Ticketsystem, keine Warteschleife. Sie schreiben mir, ich antworte. So einfach ist das. Meine Preise sind fair und transparent — ab 990€ für eine professionelle Website, die tatsächlich Kunden bringt.
            </p>
          </div>
        </div>
      </section>

...
export const metadata: Metadata = {
  ...
  description:
    "SEO Saarland ★ Suchmaschinenoptimierung für Saarbrücken, Saarlouis, Neunkirchen, Dillingen & Co. OnPage, Local SEO, Google Business. Ab 300€/Monat. Kostenlose Erstanalyse.",
  keywords: [
    "SEO Saarland",

...
export default function WebdesignerVoelklingenPage() {
    ...
    <main>
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            itemListElement: [
              ...
              { "@type": "ListItem", position: 2, name: "Webdesigner Völklingen", item: "https://www.fylumarketing.de/webdesigner-voelklingen" },
            ],
          }),
        }}
      />
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            "@context": "https://schema.org",
            "@type": "LocalBusiness",
            name: "Fylu – Webdesigner Völklingen",
            description: "Webdesigner für Völklingen. Individuelle Websites, SEO und Google Ads für lokale Unternehmen.",
            url: "https://www.fylumarketing.de/webdesigner-voelklingen",
      ...
      <section className="relative py-20 md:py-32 px-6 bg-white overflow-hidden">
        <div className="max-w-4xl mx-auto relative z-10">
          ...
          >
            Webdesigner Völklingen – Ihre Website, Ihr Vorteil
          </motion.h1>
          <motion.p

...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  const staticEntries: MetadataRoute.Sitemap = [
    ...
    { url: `${baseUrl}/geo`, lastModified: now, changeFrequency: "weekly", priority: 0.9 },
    { url: `${baseUrl}/geo-saarland`, lastModified: now, changeFrequency: "weekly", priority: 0.85 },
    { url: `${baseUrl}/local-seo-saarland`, lastModified: now, changeFrequency: "weekly", priority: 0.9 },
    ...
    { url: `${baseUrl}/ratgeber/seo-agenturen-saarland`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
